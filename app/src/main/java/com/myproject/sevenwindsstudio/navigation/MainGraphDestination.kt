...
sealed class MainGraphDestination(val destination: String) {
    ...
    data object CoffeeShop: MainGraphDestination("${NavGraphTabs.Main.route}_CoffeeShopGraph")
    data object Cart: MainGraphDestination("${NavGraphTabs.Main.route}_CartGraph/{idEstablishment}")
}
